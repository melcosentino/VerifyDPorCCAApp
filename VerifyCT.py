...
#        self.CTin3D.setText(_translate("MainWindow", "See CT in 3D"))
    ...
    def CreateSpectrogram(self):
        ...
        # Find the file to open and read the part of the click train
        ...
        if Start < 0:
            Start = 0
        s.seek(int(Start))
        Signal = s.read(int(End) - int(Start))
        self.fs = s.samplerate
        s.close()
        ...
        Pxx = 10*np.log10(self.sxx**2)
        plt_item = pg.PColorMeshItem(Pxx.T)
