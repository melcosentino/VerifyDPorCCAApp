...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.WrongButton.setText(_translate("MainWindow", "Correct (puts a 1)"))
            ...
            for SubFolder in Folders:
                ...
                if len(CTInfo) > 0:
                    for i in range(0, len(CTInfo)):
                        ...
                        print(NewCTNum)
                        CTrains = CTrains.append(CTTemp)
                    AllCTInfo['Corr'] = 0
                    AllCTInfo.reset_index(inplace=True, drop=True)
                    AllCTrains.reset_index(inplace=True, drop=True)
                    AllCTInfo = pd.concat([AllCTInfo, CTInfo], ignore_index=True)
                    AllCTrains = pd.concat([AllCTrains, CTrains], ignore_index=True)
